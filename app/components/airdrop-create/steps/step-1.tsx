...
const AirdropSetupStepOne = ({ airdropData, setAirdropData, setStep, validAddress }: StepOneProps) => {
  ...
  return <div className="flex flex-col grow justify-start w-full h-full max-h-full">
    <div className="flex-1 w-full h-full overflow-auto">
      <div className="flex flex-col h-full gap-4 max-w-md w-md mx-auto items-center">
